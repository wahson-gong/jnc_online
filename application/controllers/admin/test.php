...
class AutotableController extends BaseController{
	...
	public function indexAction(){
	   ...
	   $u6 =empty($_REQUEST['u6'])? "" : $_REQUEST['u6'];
...

	    {
...

	        {
...

	            {
	                ...
	                $temp_page_url_param_array = array(
	                    "{$v['u1']}" => "{$u6}"
	                )
	                //增加分页链接参数
	                $page_url_param_array = $page_url_param_array + $temp_page_url_param_array ;
	    ...
	    $page = new Page($total, $pagesize, $current, "index.php", $page_url_param_array);
