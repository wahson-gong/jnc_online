...
class WechatController extends BaseController
{
    ...
    public function callbackAction(){
        ...
        $_SESSION['cdsile_openid'] = $json->openid;
    ...
    public function infoBackAction(){
        ...
        $_SESSION['cdsile_openid'] = $json->openid;
        $id = $_GET['id'];
        //return $this->jump("http://jnc.cdsile.cn/?c=single&m=act_zpxq&id=$id",'',0);
        return $this->jump("http://jnc.cdsile.cn/?c=prize&a=del&id=$id",'',0);
