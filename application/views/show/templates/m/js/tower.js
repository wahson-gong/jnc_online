...
$(function () {
        ...
        $.get('index.php?p=show&c=login&a=usercheck',{tel:tel},function (msg) {
            if (msg == '9') {
                ...
                $('.Ta_close').click(function () {
                    window.location.href = '/?c=single&m=act_jzzl';
                })
                return false;
            } else {
                if (pdn) {
                    var tel = $('.Input_t1').val();
                    $.post('index.php?p=show&c=alisms&a=send', {tel: tel});
                    pdn = false;
    ...
    //         $('#Test_a').html(tian)
    //         if (tian >= 10) {
    //             $(".Timek .t1").html(Math.floor(tian / 10));
    //             $(".Timek .t2").html(tian % 10);
    //         } else {
    //             $(".Timek .t1").html(0);
    //             $(".Timek .t2").html(tian);
    //         }
    //         if (shi >= 10) {
    //             $(".Timek .t3").html(Math.floor(shi / 10));
    //             $(".Timek .t4").html(shi % 10);
    //         } else {
    //             $(".Timek .t3").html(0);
    //             $(".Timek .t4").html(shi);
    //         }
    //         if (fen >= 10) {
    //             $(".Timek .t5").html(Math.floor(fen / 10));
    //             $(".Timek .t6").html(fen % 10);
    //         } else {
    //             $(".Timek .t5").html(0);
    //             $(".Timek .t6").html(fen);
    //         }
    //         if (miao >= 10) {
    //             $(".Timek .t7").html(Math.floor(miao / 10));
    //             $(".Timek .t8").html(miao % 10);
    //         } else {
    //             $(".Timek .t7").html(0);
    //             $(".Timek .t8").html(miao);
    //         }
